package com.lawencon.ticket.validation;
...
import com.lawencon.ticket.validation.annotation.MetaData;
import com.lawencon.ticket.validation.annotation.MetaDatas;
    ...
    public static Map<String, List<String>> getErrorsFrom(BindingResult result,
        ...
        if (result.hasFieldErrors()) {
            ...
            for (FieldError fieldError : result.getFieldErrors()) {
                ...
                String errorMessage =
                        messageSource.getMessage(Objects.requireNonNull(fieldError.getCode()),
